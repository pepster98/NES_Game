...
;Load an attribute table into ppu
.macro ppu_load_attribute source, index
	lda PPUADDR
	lda index
	sta PPUADDR	;write the high byte of xxC0
	lda #$C0
	sta PPUADDR	;write the low byte of xxC0
	ldx #$00
:
	lda source, x
	sta PPUDATA
...
;Protip: index should be in the OAM_BASE (0200)
.macro ppu_load_metaSprite source, index
	bank_load #$0E
	ldx #$00
:
	lda source, x
	sta OAM_BASE + index, x
	inx
	cpx #$10	;4 sprites
	bne :-
	bank_load #$00
